...
include $(CLEAR_VARS)
LOCAL_MODULE            := usb
LOCAL_SRC_FILES         := $(GSTREAMER_ROOT)/lib/libusb-1.0.a
LOCAL_EXPORT_C_INCLUDES := $(GSTREAMER_ROOT)/include/libusb-1.0
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE            := usbredirhost
LOCAL_SRC_FILES         := $(GSTREAMER_ROOT)/lib/libusbredirhost.a
LOCAL_EXPORT_C_INCLUDES := $(GSTREAMER_ROOT)/include
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE            := usbredirparser
LOCAL_SRC_FILES         := $(GSTREAMER_ROOT)/lib/libusbredirparser.a
LOCAL_EXPORT_C_INCLUDES := $(GSTREAMER_ROOT)/include
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_C_INCLUDES += \
                    ...
                    $(GSTREAMER_ROOT)/include/libusb-1.0 \
...
LOCAL_STATIC_LIBRARIES := spice-client-glib govirt rest usb usbredirhost usbredirparser iconv \
                          intl orc avcodec spiceglue vpx avcodec lz4 opus
