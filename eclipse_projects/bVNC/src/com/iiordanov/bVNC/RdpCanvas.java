...
public class RdpCanvas extends VncCanvas implements LibFreeRDP.UIEventListener, LibFreeRDP.EventListener {
	 ...
	 * @param context
	 */
	public RdpCanvas(final Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		Thread t = new Thread () {
			public void run() {
			    try {
			    	...
			    	if (connection.getConnectionType() == 0) {
			    		...
			    		pointer = new RemoteRdpPointer (rfbconn, RdpCanvas.this, handler);
			    		keyboard = new RemoteRdpKeyboard (rfbconn, RdpCanvas.this, handler);
						
						session.setUIEventListener(RdpCanvas.this);
			    		LibFreeRDP.setEventListener(RdpCanvas.this);
			    		...
			    		rfbconn = rfb;
			    		pointer = new RemoteVncPointer (rfbconn, RdpCanvas.this, handler);
			    		keyboard = new RemoteVncKeyboard (rfbconn, RdpCanvas.this, handler);
			    		...
			    		cc = new CConn(RdpCanvas.this, sock, null, false, connection);
			    		rfbconn = cc;
			    		pointer = new RemoteVncPointer (rfbconn, RdpCanvas.this, handler);
			    		keyboard = new RemoteVncKeyboard (rfbconn, RdpCanvas.this, handler);
	...
	private Runnable drawableSetter = new Runnable() {
		public void run() {
			if (bitmapData != null)
				bitmapData.setImageDrawable(RdpCanvas.this);
			}
	};
