...
public class RdpCanvasActivity extends VncCanvasActivity implements OnKeyListener {
 ...
 */
	...
	void continueConnecting () {
		...
		vncCanvas = (RdpCanvas) findViewById(R.id.vnc_canvas);
		...
		zoomer.setOnZoomInClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				showZoomer(true);
				vncCanvas.scaling.zoomIn(RdpCanvasActivity.this);
		...
		zoomer.setOnZoomOutClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				showZoomer(true);
				vncCanvas.scaling.zoomOut(RdpCanvasActivity.this);
	...
	private void correctAfterRotation () {
		...
		vncCanvas.scaling.setScaleTypeForActivity(RdpCanvasActivity.this);
	...
	private void selectColorModel() {
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				connection.save(database.getWritableDatabase());
    			database.close();
				Toast.makeText(RdpCanvasActivity.this, "Updating Color Model to " + cm.toString(), Toast.LENGTH_SHORT).show();
			}
		});
