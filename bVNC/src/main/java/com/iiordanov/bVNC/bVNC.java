...
//                selected.save(bVNC.this);
    ...
    protected void setVisibilityOfSshWidgets(int visibility) {
        android.util.Log.d(TAG, "setVisibilityOfSshWidgets called");
    ...
    private void setRemoteWidthAndHeight() {
        android.util.Log.d(TAG, "setRemoteWidthAndHeight called");
    ...
    private void setVisibilityOfUltraVncWidgets(int visibility) {
        android.util.Log.d(TAG, "setVisibilityOfUltraVncWidgets called");
    ...
    protected Dialog onCreateDialog(int id) {
        android.util.Log.d(TAG, "onCreateDialog called");
    ...
    public void updateViewFromSelected() {
        android.util.Log.d(TAG, "updateViewFromSelected called");
        if (selected == null)
            return;
        ...
        checkboxUseLastPositionToolbar.setChecked((!isNewConnection) ? selected.getUseLastPositionToolbar() : useLastPositionToolbarDefault());
    ...
    public void updateRepeaterInfo(boolean useRepeater, String repeaterId) {
        android.util.Log.d(TAG, "updateRepeaterInfo called");
        if (useRepeater) {
    ...
    protected void updateSelectedFromView() {
        android.util.Log.d(TAG, "updateSelectedFromView called");
    ...
    private boolean useLastPositionToolbarDefault() {
